...
And also try to give whom in that {company_info} can we sell our product like for example to the CTO,COO or CEO like that etc with their name if possible.
